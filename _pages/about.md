...
Junteng Liu (刘峻腾) is a first-year Ph.D. candidate in the [HKUST NLP Group](https://nlp.hkust.edu.hk/) at the Hong Kong University of Science and Technology (HKUST), advised by [Prof. Junxian He](https://www.cse.ust.hk/~jhexian/). He received his B.Eng. from Shanghai Jiao Tong University (SJTU) in June 2024.

His research broadly falls under natural language processing and machine learning. His current research interests include:
...
- **Sep 2024:** Began Ph.D. studies at HKUST.
...
Full list with BibTeX entries is available on the [Publications](/LJT-Homepage/publications/) page.
